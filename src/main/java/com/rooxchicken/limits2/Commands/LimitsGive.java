...
public class LimitsGive implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        Bukkit.getServer().dispatchCommand(sender, "give @s netherite_sword{display:{Name:'{\"text\":\"Limiter Sword\",\"color\":\"dark_red\",\"bold\":true,\"italic\":true}',Lore:['{\"text\":\"The ultimate sword. Limits everybody but you.\",\"color\":\"dark_red\",\"bold\":false}','{\"text\":\"Gives all abilities\",\"color\":\"dark_red\",\"bold\":true}']},Unbreakable:1b,Enchantments:[{id:\"minecraft:looting\",lvl:3s},{id:\"minecraft:sharpness\",lvl:5s},{id:\"minecraft:sweeping\",lvl:3s},{id:\"minecraft:mending\",lvl:1s},{id:\"minecraft:unbreaking\",lvl:3s}]} 1");
